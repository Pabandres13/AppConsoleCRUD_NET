...
namespace ToDo
{
    internal class Program
    {
        ...
        /// <summary>
        /// Show the optios for Task 1. Nueva tarea, 2. Remover tarea, 3. Tareas pendientes, 4. Salir
        /// </summary>
        ...
        public static void ShowMenuRemove()
        {
            try
            {
                ...
                string taskNumeberToDelete = Console.ReadLine();
                
                // Remove one position because the array starts in 0
                int indexToRemove = Convert.ToInt32(taskNumeberToDelete) - 1;
